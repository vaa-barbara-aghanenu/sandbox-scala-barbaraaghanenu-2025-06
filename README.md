...
Check code style using [scalafmt](https://scalameta.org/scalafmt/). The
configuration in `.scalafmt.conf` enforces Scala 2.13 dialect formatting.

```bash
sbt scalafmtCheck    # verify formatting
sbt scalafmt         # automatically format the code
```
